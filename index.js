        ...
        productDiv.innerHTML=`
          ...
          <div class="card-body">
            ...
            <div class="card-actions justify-between mt-5">
              <button onclick="loadDetails(${product.id})" class="btn border-1 border-[#DBDEE4] hover:border-[#3B25C1] bg-[#FFFFFF] text-[#5B6473] hover:text-[#3B25C1] lg:w-34 w-28"> <i class="fa-regular fa-eye"></i> Default</button>
...
const allCategories = document.getElementById("categories")
    ...
    for(let category of categories){
        ...
        categoryDiv.classList.add("btn", "border-1" ,"border-[#3B25C1]", "hover:border-[#3B25C1]", "bg-[#FFFFFF]", "hover:bg-[#3B25C1]", "focus:bg-[#3B25C1]","focus:text-[#FFFFFF]", "text-[#3B25C1]", "hover:text-[#FFFFFF]", "focus:text-[#FFFFFF]" ,"m-2",  "rounded-full");
...
const detailsContainer = document.getElementById("details-container")
      detailsContainer.innerHTML = ` <div class="card-body">
            <div class="flex justify-between items-center">
              <div class=""><p class="font-bold text-[15px]" >$${product.price}</p></div>
              <div class=""> <i class="fa-solid fa-star text-[#FED232]"></i>
                <span class="text-[#5B6473]">${product?.rating?.rate} (${product?.rating?.count})</span>
              </div>
            </div>
            <h2 class="card-title -mb-2 py-4 " >
              ${product.title}
            </h2>
            <p class="text-[13px] mb-4" >$${product.description}</p>
            
            <div class="card-actions justify-between mt-5">
              <button " class="btn border-1 border-[#DBDEE4] hover:border-[#3B25C1] bg-[#FFFFFF] text-[#5B6473] hover:text-[#3B25C1] ">Buy Now</button>
              <button class="btn border-1 border-[#3B25C1] hover:border-[#3B25C1] bg-[#3B25C1] hover:bg-[#FFFFFF] text-white hover:text-[#3B25C1]  "> <i class="fa-solid fa-cart-plus"></i> Add to Cart</button>
            </div>
          </div>`
